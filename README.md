...
| 源程序量 | 83 个源程序文件，共 7726 行（Java 源程序 2476 行、MyBatis 映射文件 567 行、前端页面 3961 行、系统配置 40 行、数据库脚本 521 行、单元测试 161 行），按每页 50 行排版共 155 页 |
...
| 材料 | 说明 |
| --- | --- |
| 源程序文档 | 已生成 [`docs/源程序.txt`](docs/源程序.txt)（83 个源程序文件，每页 50 行，共 161 页）；源程序变动后可执行 `python3 tools/source_doc.py --output docs/源程序.txt` 重新生成，按“前后各连续 30 页”提交时追加 `--head-tail 30` |
