...
| 源程序量 | 189 个源程序文件，共 33782 行（Java 源程序 12465 行、MyBatis 映射文件 2066 行、前端页面 16333 行、系统配置 52 行、数据库脚本 2292 行、单元测试 574 行），剥离注释后 27432 行；按每页 50 行正文排版生成的源程序文档共 564 页，提交用文档为前 30 页与后 30 页（共 60 页），页眉含软件名称与版本号 |
